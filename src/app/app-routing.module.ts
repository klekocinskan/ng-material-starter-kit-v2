...
@NgModule({
  imports: [RouterModule.forRoot([{ path: 'products', component: FilteringSingleProductCategoryComponent }, { path: 'products-be', component: FilteringSingleBeProductComponent }, { path: 'users', component: FilteringSingleUserComponent }, { path: 'sorted-products', component: SortSingleProductComponent }, { path: 'users-sorted', component: SortingSingleUserComponent }]), FilteringSingleProductCategoryComponentModule, FilteringSingleBeProductComponentModule, FilteringSingleUserComponentModule, SortSingleProductComponentModule, SortingSingleUserComponentModule],
